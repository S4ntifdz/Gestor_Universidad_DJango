...
class Estudiante(models.Model):
    ...
    #si es que se borra una carrera, se borran todos los estudiantes
...
class Matricula(models.Model):
    ...
    fechaMatricula = models.DateTimeField(auto_now_add=True) #se agrega automaticamente cuando se graba un registro
